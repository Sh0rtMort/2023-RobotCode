...
public class ArmHigh extends CommandBase  {
  ...
  public void execute() {
    ...
    m_armSubsystem.setSpeeds(0.4*shoulderSpeed, elbowSpeed, wristSpeed); //Sets the speeds for the elbow and wrist motors Shoulder speed set to 0 for testing purposes
