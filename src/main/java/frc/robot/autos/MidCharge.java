...
import edu.wpi.first.math.geometry.Pose2d; //Both Rotation and Translation
import edu.wpi.first.math.geometry.Rotation2d; //Spin values
import edu.wpi.first.math.geometry.Translation2d; //Movement on (x,y) axis
